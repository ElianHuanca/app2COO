...
class ManualMarker1 extends StatelessWidget {
  const ManualMarker1({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<SearchBloc, SearchState>(
      builder: (context, state) {
        return state.displayManualMarker
            ? const _ManualMarkerBody1()
            : const SizedBox();
      },
    );
  }
...
class _ManualMarkerBody1 extends StatelessWidget {
  const _ManualMarkerBody1({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
