...
import 'package:proyectosig/ui/ui.dart';
      ...
      child: CircleAvatar(
        ...
        child: IconButton(
            icon: const Icon(Icons.my_location_rounded,
                color: Colors
                    .black), //Icon( Icons.my_location_outlined, color: Colors.black ),
            onPressed: () {
              ...
              /* final double Latitud =  userLocation!.latitude;
              final double Longitud =  userLocation!.longitude;
